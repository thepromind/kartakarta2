            ...
            <TabPanel value={value} index={2}>
              ...
              <ExpansionPanel square expanded={expanded === 'panel9'} onChange={handleChangePanel('panel9')}>
                ...
                <ExpansionPanelDetails>
                  ...
                  <img src="credit_card_graph_1.svg" className={classes.graphPanel} />
                  </Typography>
                </ExpansionPanelDetails>
              </ExpansionPanel>
              <ExpansionPanel square expanded={expanded === 'panel10'} onChange={handleChangePanel('panel10')}>
                ...
                <ExpansionPanelDetails>
                  <Typography>
                    ...
                    Например, 1 марта Вы купили товар без рассрочки на 5 000 Т, 15 марта в рассрочку на 15 000 Т у нашего партнера (сроком на 3 мес). Если до 25 апреля Вы внесете на #картакарта 10 000 Т (долг без рассрочки 5 000 Т + ежемесячный платеж по рассрочке 5 000 Т), то проценты за март не начислятся.
                    </Typography>

                  <img src="credit_card_graph_2.svg" className={classes.graphPanel} />
                </ExpansionPanelDetails>
              </ExpansionPanel>
...
Например, Вы использовали кредитный лимит в марте. 1 апреля Банк выставляет сумму минимального платежа. Срок оплаты - до 25 апреля
                  ...
                  <img src="credit_card_graph_1.svg" className={classes.graphNew} />
                </ExpansionPanelDetails>
              </ExpansionPanel>
...
Например, в мае Вы совершили покупку в рассрочку на 60 000 Т на срок 3 месяца. Сумма делится на 3 части. Каждый месяц (июнь, июль, август) Вы возвращаете по 20 000 Т и не платите проценты.<br />
Плановый (ежемесячный) платеж по рассрочке 20 000 Т автоматически включается в сумму минимального платежа, выставляемого Банком для оплаты 1-ого числа каждого месяца
          </Typography>
